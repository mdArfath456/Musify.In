...
function RegisterForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast(data.message || "Account created. Check your email for a code.", { type: "success" });
      navigate("/verify-otp", {
        state: { email: data.email, maskedEmail: data.maskedEmail, purpose: "verify-email" },
      });
    } catch (err) {

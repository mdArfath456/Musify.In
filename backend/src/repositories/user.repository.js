...
const COLUMNS =
    "id, username, email, password, role, is_verified, otp_hash, otp_purpose, otp_expiry, otp_attempts, reset_token_hash, reset_token_expires_at, failed_login_attempts, lock_until, token_version, age, accepted_terms, first_login_verified, created_at"

// Postgres is snake_case while the rest of the app expects camelCase fields.
function mapUser(row) {
    ...
    return {
        ...
        firstLoginVerified: row.first_login_verified
    }
}
...
const PATCH_TO_COLUMN = {
    ...
    firstLoginVerified: "first_login_verified"
}
